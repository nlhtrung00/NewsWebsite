import { Container,Wrapper,Content } from "./DeclinedTopics.styles";
         ...
         {state.subtopics!=null&&state.subtopics.map(subtopic =>{
            ...
            <Wrapper key={subtopic.id}>
                <Content >
                    ...
                    <button className="no" value={subtopic.id} onClick={Decline} ><i className="fas fa-times icon"></i>Decline</button>
                    <button className="yes" value={subtopic.id} onClick={Approve}><i className="fas fa-check icon"></i>Approve</button>    
                    </div>     */}
                </Content>
            </Wrapper>
           ) })}
